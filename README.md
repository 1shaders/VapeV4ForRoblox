...
```luau
loadstring(game:HttpGet("https://raw.githubusercontent.com/1shaders/VapeV4ForRoblox/main/NewMainScript.lua", true))()
```
...
2. Making sure you have connection to [the main loadstring.](https://raw.githubusercontent.com/1shaders/VapeV4ForRoblox/refs/heads/main/NewMainScript.lua)
